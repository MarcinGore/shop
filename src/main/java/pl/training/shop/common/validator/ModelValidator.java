...
public class ModelValidator {
    ...
    private void validate(MethodSignature methodSignaturem, Object argument, int argumentIndex){
        Annotation[] annotations = getAnnotation(methodSignaturem,argumentIndex);
    ...
    private Annotation[] getAnnotation(MethodSignature methodSignature,int argumentIndex){
